...
export class default1672173018872 implements MigrationInterface {
    name = 'default1672173018872'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auctions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "year" integer NOT NULL, "kilometers" integer NOT NULL, "price" character varying NOT NULL, "vehicle_type" character varying NOT NULL, "images" character varying NOT NULL, "time_limit" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_87d2b34d4829f0519a5c5570368" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "productId" uuid, "auctionId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "year" integer NOT NULL, "kilometers" integer NOT NULL, "price" character varying NOT NULL, "vehicle_type" character varying NOT NULL, "images" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "auctions" ADD CONSTRAINT "FK_16dc675bdc61af03510d2b10bab" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_4f82f6e2ccc56317180739ee6c8" FOREIGN KEY ("auctionId") REFERENCES "auctions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_4f82f6e2ccc56317180739ee6c8"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_9f8304787dd13d61bc94afd07b0"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_7e8d7c49f218ebb14314fdb3749"`);
        await queryRunner.query(`ALTER TABLE "auctions" DROP CONSTRAINT "FK_16dc675bdc61af03510d2b10bab"`);
